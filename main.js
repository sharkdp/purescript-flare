...
(function(exports) {
  ...
  var runFlare = function (__dict_Show_7) {
          ...
          return function (target) {
              return function (_6) {
                  return function __do() {
                      ...
                      return Signal.runSignal(Signal["~>"](Signal.functorSignal)(_5.value1)(Prelude[">>>"](Prelude.semigroupoidFn)(Prelude.show(__dict_Show_7))($foreign.renderString(target))))();
                  };
              };
          };
      };
  ...
  var main = function __do() {
      ...
      var greet = function (name) {
          return function (french) {
              ...
              throw new Error("Failed pattern match at Test.Main line 17, column 7 - line 20, column 3: " + [ name.constructor.name, french.constructor.name ]);
          };
      };
      Flare.runFlare(Prelude.showString)("controls2")("output2")(Prelude["<*>"](Flare.applyUI)(Prelude["<$>"](Flare.functorUI)(greet)(Flare.string("Name")("Pierre")))(Flare["boolean"]("French greeting")(true)))();
      Flare.runFlare(Prelude.showString)("controls3")("output3")(Prelude["<>"](Flare.semigroupUI(Prelude.semigroupString))(Flare.string_("Hello"))(Prelude["<>"](Flare.semigroupUI(Prelude.semigroupString))(Prelude.pure(Flare.applicativeUI)(" "))(Flare.string_("World"))))();
      Flare.runFlare(Prelude.showInt)("controls4")("output4")(Data_Foldable.sum(Data_Foldable.foldableArray)(Flare.semiringUI(Prelude.semiringInt))(Prelude["<$>"](Prelude.functorArray)(Flare.int_)([ 2, 13, 27, 42 ])))();
      Flare.runFlare(Prelude.showNumber)("controls5")("output5")(Prelude["/"](Flare.moduloSemiringUI(Prelude.moduloSemiringNumber))(Flare.number_(5.0))(Flare.number_(2.0)))();
      Flare.runFlare(Prelude.showArray(Prelude.showString))("controls6")("output6")(Prelude["<*>"](Flare.applyUI)(Prelude["<$>"](Flare.functorUI)(Data_Array.replicate)(Flare.int_(4)))(Flare.string_("foo")))();
      return Flare_Drawing.runFlareDrawing("controls7")("output7")(Prelude["<$>"](Flare.functorUI)(Graphics_Drawing.filled(Graphics_Drawing.fillColor(Graphics_Drawing_Color.red)))(Prelude["<$>"](Flare.functorUI)(Graphics_Drawing.circle(50.0)(50.0))(Flare.number("Radius")(25.0))))();
  };
  exports["main"] = main;;
