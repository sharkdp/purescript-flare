...
(function(exports) {
  ...
  var showLanguage = new Prelude.Show(function (_1) {
      ...
      throw new Error("Failed pattern match at Test.Main line 16, column 1 - line 21, column 1: " + [ _1.constructor.name ]);
  });
  var greet = function (_0) {
      ...
      throw new Error("Failed pattern match at Test.Main line 21, column 1 - line 22, column 1: " + [ _0.constructor.name ]);
  };
  var main = function __do() {
      ...
      var animate = function (time) {
          return function (enabled) {
              ...
              throw new Error("Failed pattern match at Test.Main line 51, column 7 - line 58, column 3: " + [ enabled.constructor.name ]);
          };
      };
      return Flare_Drawing.runFlareDrawing("controls7")("output7")(Prelude["<*>"](Flare.applyUI)(Prelude["<$>"](Flare.functorUI)(animate)(Flare.lift(Signal_DOM.animationFrame)))(Flare["boolean"]("Shadow")(false)))();
  };
