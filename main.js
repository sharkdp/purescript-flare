...
(function(exports) {
  ...
  var ui18 = (function () {
      var defaultList = new Data_List_Types.Cons("Don't", new Data_List_Types.Cons("Repeat", new Data_List_Types.Cons("Yourself", Data_List_Types.Nil.value)));
      var acronym = function (xs) {
          return "Acronym: " + Data_Foldable.foldMap(Data_List_Types.foldableList)(Data_Monoid.monoidString)(Data_String.take(1))(xs);
      };
      return Data_Functor.map(Flare.functorUI)(acronym)(Flare.resizableList("Words")(Flare.string_)("Really")(defaultList));
  })();
  var ui17 = (function () {
  ...
  var toString = function (v) {
      ...
      throw new Error("Failed pattern match at Test.Main line 79, column 1 - line 80, column 1: " + [ v.constructor.name ]);
  };
  ...
  var showDomain = function (v) {
      ...
      throw new Error("Failed pattern match at Test.Main line 171, column 1 - line 172, column 1: " + [ v.constructor.name ]);
  };
  ...
  var perform = function (v) {
      ...
      throw new Error("Failed pattern match at Test.Main line 209, column 1 - line 210, column 1: " + [ v.constructor.name ]);
  };
  var ns = function (l) {
  ...
  var light = function (on) {
      var arg = (function () {
          ...
          throw new Error("Failed pattern match at Test.Main line 222, column 9 - line 223, column 33: " + [  ]);
      })();
  ...
  var label = function (v) {
      ...
      throw new Error("Failed pattern match at Test.Main line 203, column 1 - line 204, column 1: " + [ v.constructor.name ]);
  };
  ...
  var uiColor = function (v) {
      ...
      throw new Error("Failed pattern match at Test.Main line 185, column 1 - line 188, column 1: " + [ v.constructor.name ]);
  };
  ...
  var greet = function (v) {
      ...
      throw new Error("Failed pattern match at Test.Main line 84, column 1 - line 85, column 1: " + [ v.constructor.name ]);
  };
  ...
  var main = function __do() {
      ...
      Flare.runFlare("controls17")("output17")(ui17)();
      return Flare.runFlare("controls18")("output18")(ui18)();
  };
