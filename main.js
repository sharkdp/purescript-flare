...
(function(exports) {
  ...
  var buttons = function (xs) {
      return function (toString) {
          ...
          return Prelude["<$>"](functorUI)(function ($79) {
              return Data_Array.head(Data_Array.catMaybes($79));
...
(function(exports) {
  ...
  var showDomain = function (v) {
      ...
      throw new Error("Failed pattern match at Test.Main line 129, column 1 - line 130, column 1: " + [ v.constructor.name ]);
  };
  ...
  var ui7 = Prelude["<*>"](Flare.applyUI)(Prelude["<*>"](Flare.applyUI)(Prelude["<*>"](Flare.applyUI)(Prelude["<*>"](Flare.applyUI)(Prelude["<$>"](Flare.functorUI)(plot)(Flare.numberSlider("m")(0.0)(10.0)(1.0)(7.0)))(Flare.numberSlider("n1")(1.0)(10.0)(0.1)(4.0)))(Flare.numberSlider("s")(4.0)(16.0)(0.1)(14.0)))(Flare.color("Color")(Color.hsl(333.0)(0.6)(0.5))))(Flare.lift(Signal_DOM.animationFrame));
  var perform = function (v) {
      ...
      throw new Error("Failed pattern match at Test.Main line 158, column 1 - line 159, column 1: " + [ v.constructor.name ]);
  };
  var ns = function (l) {
  ...
  var light = function (on) {
      var arg = (function () {
          ...
          throw new Error("Failed pattern match at Test.Main line 170, column 9 - line 173, column 1: " + [  ]);
      })();
  ...
  var label = function (v) {
      ...
      throw new Error("Failed pattern match at Test.Main line 153, column 1 - line 154, column 1: " + [ v.constructor.name ]);
  };
  ...
  var uiColor = function (v) {
      if (v instanceof HSL) {
          return Prelude["<*>"](Flare.applyUI)(Prelude["<*>"](Flare.applyUI)(Prelude["<$>"](Flare.functorUI)(Color.hsl)(ns("Hue")(360.0)(1.0)(180.0)))(ns("Saturation")(1.0)(1.0e-2)(0.5)))(ns("Lightness")(1.0)(1.0e-2)(0.5));
      };
      if (v instanceof RGB) {
          return Prelude["<*>"](Flare.applyUI)(Prelude["<*>"](Flare.applyUI)(Prelude["<$>"](Flare.functorUI)(Color.rgb)(is("Red")(200)))(is("Green")(0)))(is("Blue")(100));
      };
      throw new Error("Failed pattern match at Test.Main line 138, column 1 - line 141, column 1: " + [ v.constructor.name ]);
  };
  ...
  var graph = function (xs) {
      return function (width) {
          ...
          return Graphics_Drawing.outlined(Prelude["<>"](Graphics_Drawing.semigroupOutlineStyle)(Graphics_Drawing.outlineColor(Color.black))(Graphics_Drawing.lineWidth(width)))(Graphics_Drawing.path(Data_Foldable.foldableArray)(points));
      };
  };
